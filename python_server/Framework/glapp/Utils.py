...
def get_rendering_vertices(vertices, xpos, ypos, w, h, top, z=0.0):
    vertices.append((xpos,     ypos + (h-top) - h, z)) # 0, 0
    vertices.append((xpos,     ypos + (h-top)    , z)) # 0, 1
    vertices.append((xpos + w, ypos + (h-top)    , z)) # 1, 1
    vertices.append((xpos,     ypos + (h-top) - h, z)) # 0, 0
    vertices.append((xpos + w, ypos + (h-top)    , z)) # 1, 1
    vertices.append((xpos + w, ypos + (h-top) - h, z)) # 1, 0
