...
class Line(Geometry2D):
    ...
    def __init__(self, shader_program, start_point, end_point, line_width, color):
        ...
        self.update_position(start_point, end_point)
        self.color = color
    ...
    def update_position(self, start_point, end_point):
        ...
        self.vertices = np.array([
            [start_point[0]-ofx, start_point[1]+ofy, -1.0],
            [end_point[0]-ofx, end_point[1]+ofy, -1.0],
            [end_point[0]+ofx, end_point[1]-ofy, -1.0],
            [end_point[0]+ofx, end_point[1]-ofy, -1.0],
            [start_point[0]-ofx, start_point[1]+ofy, -1.0],
            [start_point[0]+ofx, start_point[1]-ofy, -1.0]
